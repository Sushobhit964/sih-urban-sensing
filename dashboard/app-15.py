...
.section{font-size:21px;font-weight:800;color:#172033;margin:7px 0 5px;letter-spacing:-.35px}.sub{font-size:13px;color:#718096;margin:0 0 16px}
...
def plot(fig,height=330):
    fig.update_layout(
        height=height, margin=dict(l=12,r=14,t=52,b=14),
        ...
        title=dict(font=dict(size=15,color="#172033",family="-apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica, Arial, sans-serif")),
        legend=dict(orientation="h",yanchor="bottom",y=1.01,x=0,font=dict(size=10,color="#526174")),
